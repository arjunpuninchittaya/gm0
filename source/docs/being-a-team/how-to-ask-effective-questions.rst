...
2. **Provide some context.** It is often helpful to provide context for example, what you may have changed recently, what skills you are new to and hence, could be the root of the issues.
...
3. **Share your attempts.** Explain the steps you have already taken to address the problem. This can include specific troubleshooting methods, changes in code or hardware, or advice you have already sought. This helps others avoid suggesting solutions you have already attempted and can provide insights into what might still be wrong.
